...
//        utils.addMetaData(models.student, Decorators.DOCUMENT, DecoratorType.CLASS, { name: models.student.name });
...
//        expect(utils.addMetaData).toHaveBeenCalledWith(models.student, Decorators.DOCUMENT, DecoratorType.CLASS, { name: models.student.name });
